...
public class Coder {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/cloud-uav/src/main/java");
        ...
        pc.setModuleName("cloud-uav");
        pc.setParent("com.ccssoft.clouduav");
        pc.setEntity("entity");
        pc.setMapper("dao");
        ...
        strategy.setInclude("user_uav");//设置要映射的表名
